...
char questionHistoire[][100] = {"Quand a eu lieu la Révolution française ? ","Qui a fonder l'Empire romain ?","Quelle était la principale cause de la Première Guerre mondiale ?", "Qui était Mahatma Gandhi ?","Qu'est-ce que la Renaissance ?","Qui étaient les principaux leaders de la lutte pour les droits civiques aux États-Unis","Quelles sont les principales caractéristiques de l'Empire mongol ?", "Quand a commence la révolution industrielle ?"};
